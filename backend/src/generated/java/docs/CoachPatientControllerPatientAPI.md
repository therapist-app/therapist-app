...
|------------- | ------------- | -------------|
| [**deletePatient**](CoachPatientControllerPatientAPI.md#deletePatient) | **DELETE** /coach/patients/{patientId} |  |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.deletePatient(patientId);
        } catch (ApiException e) {
            System.err.println("Exception when calling CoachPatientControllerPatientAPI#deletePatient");
