...
|------------- | ------------- | -------------|
| [**createExercise**](CoachExerciseControllerPatientAPI.md#createExercise) | **POST** /coach/patients/{patientId}/exercises |  |
...
| [**getExerciseInformation**](CoachExerciseControllerPatientAPI.md#getExerciseInformation) | **GET** /coach/patients/{patientId}/exercises/{exerciseId} |  |
...
> List&lt;ExerciseInformationOutputDTOPatientAPI&gt; getExerciseInformation(patientId, exerciseId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String exerciseId = "exerciseId_example"; // String | 
        try {
            List<ExerciseInformationOutputDTOPatientAPI> result = apiInstance.getExerciseInformation(patientId, exerciseId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CoachExerciseControllerPatientAPI#getExerciseInformation");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
[**List&lt;ExerciseInformationOutputDTOPatientAPI&gt;**](ExerciseInformationOutputDTOPatientAPI.md)
