...
public class TherapistController {
  ...
  public TherapistOutputDTO createTherapist(
      @RequestBody CreateTherapistDTO therapistInputDTO, HttpServletRequest httpServletRequest,
  ...
  public TherapistOutputDTO loginTherapist(
      @RequestBody LoginTherapistDTO loginTherapistDTO, HttpServletRequest httpServletRequest,
      HttpServletResponse httpServletResponse) {
    Therapist loggedInTherapist = therapistService.loginTherapist(loginTherapistDTO,
