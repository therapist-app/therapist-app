...
public class PatientDocumentController {
    ...
    public PatientDocumentController(PatientDocumentService patientDocumentService, TherapistService therapistService) {
    ...
    public void createPatientDocument(@PathVariable String patientId, @RequestParam("file") MultipartFile file,
