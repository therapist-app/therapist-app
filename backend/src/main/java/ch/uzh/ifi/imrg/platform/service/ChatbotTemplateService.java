...
public class ChatbotTemplateService {
    ...
    public ChatbotTemplate updateTemplate(String therapistId, String templateId, ChatbotTemplate template) {
        ChatbotTemplate existingTemplate = chatbotTemplateRepository.findByIdAndTherapistId(templateId, therapistId)
    ...
    public void deleteTemplate(String therapistId, String templateId) {
        ChatbotTemplate template = chatbotTemplateRepository.findByIdAndTherapistId(templateId, therapistId)
                .orElseThrow(() -> new Error("Template not found with id: " + templateId));
        chatbotTemplateRepository.delete(template);
    }

    public ChatbotTemplate cloneTemplate(String therapistId, String templateId) {
        ChatbotTemplate original = chatbotTemplateRepository.findByIdAndTherapistId(templateId, therapistId)
                .orElseThrow(() -> new Error("Template not found with id: " + templateId));
