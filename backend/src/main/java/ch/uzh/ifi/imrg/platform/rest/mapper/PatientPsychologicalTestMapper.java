...
public interface PatientPsychologicalTestMapper {
    ...
    PsychologicalTestOutputDTO toPsychologicalTestOutputDTO(PsychologicalTestOutputDTOPatientAPI apiDTO);

    default List<PsychologicalTestQuestionOutputDTO> mapQuestions(List<PsychologicalTestQuestionOutputDTOPatientAPI> questions) {
        if (questions == null) {
            return null;
        }
