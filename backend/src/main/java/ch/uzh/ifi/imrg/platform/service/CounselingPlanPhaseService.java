...
public class CounselingPlanPhaseService {
    ...
    public CounselingPlanPhaseOutputDTO updateCounselingPlanPhase(String counselingPlanPhaseId,
            CreateCounselingPlanPhaseDTO updateDto) {
        CounselingPlanPhase counselingPlanPhase = counselingPlanPhaseRepository
                .findById(counselingPlanPhaseId)
                .orElseThrow(() -> new Error("Counseling plan phase not found with id: " + counselingPlanPhaseId));
