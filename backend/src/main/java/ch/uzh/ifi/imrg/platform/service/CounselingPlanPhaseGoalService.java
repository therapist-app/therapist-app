...
public class CounselingPlanPhaseGoalService {
    ...
    public CounselingPlanPhaseGoalOutputDTO updateCounselingPlanPhaseGoal(String phaseGoalId,
            CreateCounselingPlanPhaseGoalDTO updateDto) {
        CounselingPlanPhaseGoal counselingPlanPhaseGoal = counselingPlanPhaseGoalRepository
                .getReferenceById(phaseGoalId);
        ...
        return CounselingPlanPhaseGoalMapper.INSTANCE
                .convertEntityToCounselingPlanPhaseGoalOutputDTO(counselingPlanPhaseGoal);
    }
