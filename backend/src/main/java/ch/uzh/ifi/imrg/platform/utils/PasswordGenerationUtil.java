...
public class PasswordGenerationUtil {
    ...
    private static final List<String> ADJECTIVES = Arrays.asList(
            ...
            "Proud", "Silly", "Witty", "Zesty", "Sunny", "Cloudy", "Windy", "Quiet", "Brave", "Clever");

    private static final List<String> NOUNS = Arrays.asList(
            "River", "Mountain", "Forest", "Ocean", "Planet", "Star", "Comet", "Moon", "Sun", "Sky",
            "Apple", "Banana", "Cherry", "Grape", "Lemon", "Orange", "Peach", "Pear", "Robot", "Dragon");
