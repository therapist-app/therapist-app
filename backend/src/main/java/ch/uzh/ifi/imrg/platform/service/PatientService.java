...
public class PatientService {
    ...
    public PatientOutputDTO createPatient(PatientInputDTO inputDTO) {
    ...
    public PatientOutputDTO createPatientForTherapist(String therapistId, PatientInputDTO inputDTO) {
