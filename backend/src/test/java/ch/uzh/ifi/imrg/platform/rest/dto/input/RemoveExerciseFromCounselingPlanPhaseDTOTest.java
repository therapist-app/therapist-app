...
class RemoveExerciseFromCounselingPlanPhaseDTOTest {

    @Test
    void gettersSettersToStringEqualsHashCode() {
        RemoveExerciseFromCounselingPlanPhaseDTO dto1 = new RemoveExerciseFromCounselingPlanPhaseDTO();
        ...
        RemoveExerciseFromCounselingPlanPhaseDTO dto2 = new RemoveExerciseFromCounselingPlanPhaseDTO();
