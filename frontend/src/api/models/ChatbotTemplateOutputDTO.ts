 ...
 */
export function instanceOfChatbotTemplateOutputDTO(
  value: object
): value is ChatbotTemplateOutputDTO {
  return true
}
...
export function ChatbotTemplateOutputDTOFromJSONTyped(
  json: any,
...
export function ChatbotTemplateOutputDTOToJSONTyped(
  value?: ChatbotTemplateOutputDTO | null,
