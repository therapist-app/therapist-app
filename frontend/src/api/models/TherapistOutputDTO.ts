...
export function TherapistOutputDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): TherapistOutputDTO {
    if (json == null) {
        return json;
    }
    return {
        ...
        'chatbotTemplatesOutputDTO': json['chatbotTemplatesOutputDTO'] == null ? undefined : ((json['chatbotTemplatesOutputDTO'] as Array<any>).map(ChatbotTemplateOutputDTOFromJSON)),
        'patientsOutputDTO': json['patientsOutputDTO'] == null ? undefined : ((json['patientsOutputDTO'] as Array<any>).map(PatientOutputDTOFromJSON)),
...
export function TherapistOutputDTOToJSONTyped(value?: TherapistOutputDTO | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'chatbotTemplatesOutputDTO': value['chatbotTemplatesOutputDTO'] == null ? undefined : ((value['chatbotTemplatesOutputDTO'] as Array<any>).map(ChatbotTemplateOutputDTOToJSON)),
        'patientsOutputDTO': value['patientsOutputDTO'] == null ? undefined : ((value['patientsOutputDTO'] as Array<any>).map(PatientOutputDTOToJSON)),
