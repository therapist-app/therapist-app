 ...
 */
export function instanceOfCreateChatbotTemplateDTO(
  value: object
): value is CreateChatbotTemplateDTO {
  return true
}
...
export function CreateChatbotTemplateDTOFromJSONTyped(
  json: any,
...
export function CreateChatbotTemplateDTOToJSONTyped(
  value?: CreateChatbotTemplateDTO | null,
