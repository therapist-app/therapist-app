...
import type { CreatePatientDTO, PatientOutputDTO } from '../models/index'
import {
...
export interface PatientControllerApiInterface {
   ...
   */
  createPatientForTherapistRaw(
    requestParameters: CreatePatientForTherapistRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PatientOutputDTO>>
   ...
   * @memberof PatientControllerApiInterface
   */
  getPatientsOfTherapistRaw(
    requestParameters: GetPatientsOfTherapistRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<PatientOutputDTO>>>
  ...
  getPatientsOfTherapist(
    requestParameters: GetPatientsOfTherapistRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<PatientOutputDTO>>
}
...
export class PatientControllerApi extends runtime.BaseAPI implements PatientControllerApiInterface {
  /**
   */
  async createPatientForTherapistRaw(
    requestParameters: CreatePatientForTherapistRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<PatientOutputDTO>> {
  ...
  /**
   */
  async getPatientsOfTherapistRaw(
    requestParameters: GetPatientsOfTherapistRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<PatientOutputDTO>>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(PatientOutputDTOFromJSON)
    )
  }
