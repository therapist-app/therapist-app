...
// @ts-ignore
import type { ConversationSummaryOutputDTOPatientAPI } from '../models';
/**
...
export const ConversationControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getConversationSummary: async (patientId: string, start: string, end: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/patients/{patientId}/conversations/chatbot-summary`
...
export const ConversationControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getConversationSummary(patientId: string, start: string, end: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ConversationSummaryOutputDTOPatientAPI>> {
...
export const ConversationControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getConversationSummary(patientId: string, start: string, end: string, options?: RawAxiosRequestConfig): AxiosPromise<ConversationSummaryOutputDTOPatientAPI> {
