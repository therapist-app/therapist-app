...
import type { CreateTherapistDTO, LoginTherapistDTO, TherapistOutputDTO } from '../models/index'
import {
...
export interface TherapistControllerApiInterface {
   ...
   */
  createTherapistRaw(
    requestParameters: CreateTherapistRequest,
   ...
   * @memberof TherapistControllerApiInterface
   */
  getCurrentlyLoggedInTherapistRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TherapistOutputDTO>>
   ...
   */
  loginTherapistRaw(
    requestParameters: LoginTherapistRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TherapistOutputDTO>>
 ...
 *
 */
export class TherapistControllerApi
  extends runtime.BaseAPI
  implements TherapistControllerApiInterface
{
  /**
   */
  async createTherapistRaw(
    requestParameters: CreateTherapistRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TherapistOutputDTO>> {
  ...
  /**
   */
  async getCurrentlyLoggedInTherapistRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TherapistOutputDTO>> {
    const queryParameters: any = {}
