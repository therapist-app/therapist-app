...
export enum PAGES {
  ...
  PATIENTS_DETAILS_UPDATE_PAGE = 'PATIENTS_DETAILS_UPDATE_PAGE',
  ...
  GAD7_TEST_DETAIL_PAGE = 'GAD7_TEST_DETAIL_PAGE',

  JOURNAL_ENTRIES_DETAILS_PAGE = 'JOURNAL_ENTRIES_DETAILS_PAGE',
...
const PAGE_HIERARCHY: Record<PAGES, PAGES[]> = {
  ...
  [PAGES.PATIENTS_DETAILS_PAGE]: [
    ...
    PAGES.GAD7_TEST_DETAIL_PAGE,
    PAGES.JOURNAL_ENTRIES_DETAILS_PAGE,
...
export const ROUTES: Record<PAGES, string> = {
  ...
  [PAGES.GAD7_TEST_DETAIL_PAGE]: '/clients/:patientId/gad7',

  [PAGES.JOURNAL_ENTRIES_DETAILS_PAGE]: '/clients/:patientId/journal-entry/:journalEntryId',
...
export const PAGE_NAMES: Record<PAGES, string> = {
  ...
  [PAGES.GAD7_TEST_DETAIL_PAGE]: 'pages.gad7.manage',

  [PAGES.JOURNAL_ENTRIES_DETAILS_PAGE]: 'pages.journal_entry_details',
