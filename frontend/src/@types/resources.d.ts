interface Resources {
  "de": {
    ...
    "patient_create": {
      ...
      "add_first_complaint": "Beschwerde hinzufügen",
    ...
    "gad7test": {
      ...
      "schedule_summary": "Mit diesen Einstellungen wird der Patient den GAD7-Test alle {{days}} Tage vom {{start_date}} bis zum {{end_date}} ausfüllen.",
      "pause_test_schedule": "Testzeitplan pausieren",
      "schedule_is_paused": "Der Testzeitplan ist derzeit pausiert.",
      "loading_configurations": "Lade GAD-7-Testkonfiguration...",
      "date": "Datum",
      ...
      "cancel": "Abbrechen",
      "assign_tests": "Tests zuweisen",
      "assigned_successfully": "Tests erfolgreich zugewiesen",
      "updated_successfully": "Test Konfiguration erfolgreich aktualisiert",
      "save_changes": "Änderungen speichern",
  ...
  "en": {
    ...
    "gad7test": {
      ...
      "schedule_summary": "With these settings, the patient will fill out the GAD7 test every {{days}} days starting from {{start_date}} up to the {{end_date}}.",
      "pause_test_schedule": "Pause Test Schedule",
      "schedule_is_paused": "The schedule is currently paused.",
      "loading_configuration": "Loading GAD-7 test configuration...",
      "date": "Date",
      ...
      "cancel": "Cancel",
      "assign_tests": "Assign GAD-7 Tests",
      "assigned_successfully": "Successfully assigned GAD-7 tests.",
      "updated_successfully": "Successfully updated GAD-7 test configuration.",
  ...
  "ua": {
    ...
    "patient_create": {
      ...
      "add_first_complaint": "Додати скаргу",
    ...
    "gad7test": {
      ...
      "schedule_summary": "За цими налаштуваннями пацієнт заповнюватиме тест GAD7 кожні {{days}} днів, починаючи з {{start_date}} до {{end_date}}.",
      "pause_test_schedule": "Призупинити розклад тестів",
      "schedule_is_paused": "Розклад тестів призупинено",
      "loading_configuration": "Завантаження конфігурації тестів GAD-7...",
      "date": "Дата",
      ...
      "cancel": "Скасувати",
      "assign_tests": "Призначити тести GAD-7 клієнту",
      "assigned_successfully": "Тести GAD-7 успішно призначено клієнту.",
      "updated_successfully": "Тестова конфігурація успішно оновлена.",
      "save_changes": "Зберегти зміни",
